    ...
    <main className="min-h-screen bg-[#F6EFE7] text-[#2E2A22]">
      ...
      <section className="relative overflow-hidden border-b border-[#E4D9C8]">
        <div className="relative max-w-3xl mx-auto px-6 py-24 text-center">
          ...
          <p className="text-[#6B5D48] max-w-xl mx-auto mb-10 text-lg leading-relaxed">
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 border-b border-[#E4D9C8]">
        ...
        <Link
          href="/quienes-somos"
          className="inline-block mt-6 bg-[#B8944A] hover:bg-[#A6803D] text-[#F6EFE7] transition-colors font-medium rounded-full px-6 py-3"
        >
